...
EMSCRIPTEN_BINDINGS(artoolkit_constants) {
  ...
  // Marker Types
  //constant("AR_PATTERN_TYPE_TEMPLATE", AR_PATTERN_TYPE_TEMPLATE);
  //constant("AR_PATTERN_TYPE_MATRIX", AR_PATTERN_TYPE_MATRIX);

  // Pixel Formats
  constant("AR_PIXEL_FORMAT_RGB", AR_PIXEL_FORMAT_RGB);
  constant("AR_PIXEL_FORMAT_BGR", AR_PIXEL_FORMAT_BGR);
  constant("AR_PIXEL_FORMAT_RGBA", AR_PIXEL_FORMAT_RGBA);
  constant("AR_PIXEL_FORMAT_BGRA", AR_PIXEL_FORMAT_BGRA);
  constant("AR_PIXEL_FORMAT_MONO", AR_PIXEL_FORMAT_MONO);
  constant("AR_PIXEL_FORMAT_420f", AR_PIXEL_FORMAT_420f);
  constant("AR_PIXEL_FORMAT_420v", AR_PIXEL_FORMAT_420v);
