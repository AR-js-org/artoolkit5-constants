...
EMSCRIPTEN_BINDINGS(artoolkit_constants) {
  // Pixel Formats
  enum_<AR_PIXEL_FORMAT>("AR_PIXEL_FORMAT")
        .value("AR_PIXEL_FORMAT_RGB", AR_PIXEL_FORMAT_RGB)
        .value("AR_PIXEL_FORMAT_BGR", AR_PIXEL_FORMAT_BGR)
        .value("AR_PIXEL_FORMAT_RGBA", AR_PIXEL_FORMAT_RGBA)
        .value("AR_PIXEL_FORMAT_BGRA", AR_PIXEL_FORMAT_BGRA)
        .value("AR_PIXEL_FORMAT_MONO", AR_PIXEL_FORMAT_MONO)
        .value("AR_PIXEL_FORMAT_420f", AR_PIXEL_FORMAT_420f)
        .value("AR_PIXEL_FORMAT_420v", AR_PIXEL_FORMAT_420v)
        ;
  // Detection Modes
